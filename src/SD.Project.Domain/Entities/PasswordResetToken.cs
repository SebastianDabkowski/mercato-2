...
/// <summary>
/// Represents a unique, time-limited, single-use password reset token.
/// </summary>
public class PasswordResetToken
{
    ...
    /// <summary>
    /// The unique token string used in the reset link.
    /// </summary>
    ...
    /// <param name="validityPeriod">The time period the token will be valid for. Defaults to 1 hour.</param>
    public PasswordResetToken(Guid userId, TimeSpan? validityPeriod = null)
    {
        ...
        var validity = validityPeriod ?? TimeSpan.FromHours(1);
    ...
    public void MarkAsUsed()
    {
        ...
        if (IsExpired)
        {
            throw new InvalidOperationException("This password reset token has expired.");
        }
